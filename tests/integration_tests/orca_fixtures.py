...
_web_radio_button_lines = _make_web_fixture("web_radio_button_lines.html")
_web_blockquote_line_breaks = _make_web_fixture("web_blockquote_line_breaks.html")
...
_web_table_block_cells = _make_web_fixture("web_table_block_cells.html")
_web_grid_named_cells = _make_web_fixture("web_grid_named_cells.html")
_web_form_fields = _make_web_fixture("web_form_fields.html")
_web_form_label = _make_web_fixture("web_form_label.html")
...
_web_aria_application = _make_web_fixture("web_aria_application.html")
_web_aria_document = _make_web_fixture("web_aria_document.html")
_web_iframes = _make_web_fixture("web_iframes.html")
...
_web_nested_link_text = _make_web_fixture("web_nested_link_text.html")
_web_multi_line_content = _make_web_fixture("web_multi_line_content.html")
...
_web_sister_projects_2 = _make_web_fixture("web_sister_projects_2.html")
...
_web_menu_button = _make_web_fixture("web_menu_button.html")
_web_menubar = _make_web_fixture("web_menubar.html")
...
_web_image_descendants = _make_web_fixture("web_image_descendants.html", caret_browsing=True)
...
_web_toolbar = _make_web_fixture("web_toolbar.html")
_web_listbox = _make_web_fixture("web_listbox.html")
_web_tabs = _make_web_fixture("web_tabs.html")
_web_treegrid = _make_web_fixture("web_treegrid.html")
_web_multithumb_slider = _make_web_fixture("web_multithumb_slider.html")
_web_window_splitter = _make_web_fixture("web_window_splitter.html")
