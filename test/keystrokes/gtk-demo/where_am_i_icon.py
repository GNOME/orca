...
sequence.append(WaitForFocus("dev", acc_role=pyatspi.ROLE_ICON))
sequence.append(KeyComboAction("<Shift>Down"))
sequence.append(WaitForFocus("media", acc_role=pyatspi.ROLE_ICON))
sequence.append(KeyComboAction("<Shift>Down"))
sequence.append(WaitForFocus("srv", acc_role=pyatspi.ROLE_ICON))

# Do "where am i"
# TODO: "items selected" is false, it always gives 0.
