...
sequence.append(utils.AssertPresentationAction(
    "2. Next row",
    ["BRAILLE LINE:  'gtk3-demo application Shopping list frame table Number column header 5 packages of noodles '",
...
sequence.append(utils.AssertPresentationAction(
    ...
    ["BRAILLE LINE:  'gtk3-demo application Shopping list frame table Number column header 5 packages of noodles '",
     "     VISIBLE:  '5 packages of noodles ', cursor=1",
     "BRAILLE LINE:  'gtk3-demo application Shopping list frame table Product column header packages of noodles table cell'",
...
sequence.append(utils.AssertPresentationAction(
    ...
    ["BRAILLE LINE:  'gtk3-demo application Shopping list frame table Product column header bottles of coke table cell'",
