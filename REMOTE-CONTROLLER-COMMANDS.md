...
This document lists all commands (204), runtime getters (103), and runtime setters (93) available
...
- **`ShowActionsList`:** Shows a list with all the available accessible actions.
...
- **`SpeechIsEnabled`:** Gets/Sets whether the speech server is enabled. See also the is-muted setter.
