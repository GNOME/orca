...
To run this module, merely type 'python preferences_radio_buttons.py'.

To reproduce bug x, follow these steps:

1) Run this module in an xterm
2) Start Firefox, open the preferences dialog.
3) Arrow to the 'Tabs' preferences setup.
4) Tab to the 'Open links that would open new windows in' panel,
   giving one of the radio buttons focus.
5) In the output of this module, you will see that the
   newly focused radio button does not issue a focus event.

The item with focus should issue a 'focus' event.
"""
