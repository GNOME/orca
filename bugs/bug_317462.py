...
"""Bug reproducer for bug 317462.  This standalone module talks
directly with the AT-SPI Registry via its IDL interfaces.  No Orca
logic or code is stuck in the middle.

To run this module, merely type 'python bug_317462.py'.

To reproduce bug 317462, follow these steps:
