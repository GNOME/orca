...
class AXUtilitiesComponent:
    ...
    def objects_have_same_rect(obj1: Atspi.Accessible, obj2: Atspi.Accessible) -> bool:
        ...
        return AXUtilitiesComponent.is_same_rect(
    ...
    def objects_overlap(obj1: Atspi.Accessible, obj2: Atspi.Accessible) -> bool:
        ...
        intersection = AXUtilitiesComponent.get_rect_intersection(
    ...
    def _find_descendant_at_point(obj: Atspi.Accessible, x: int, y: int) -> Atspi.Accessible | None:
        ...
        for child in AXObject.iter_children(obj):
            if AXUtilitiesComponent._object_bounds_includes_children(child):
                continue
    ...
    def _get_descendant_at_point(obj: Atspi.Accessible, x: int, y: int) -> Atspi.Accessible | None:
        ...
        child = AXComponent.get_object_at_point(obj, x, y)
        if child is None and AXComponent.object_contains_point(obj, x, y):
            descendant = AXUtilitiesComponent._find_descendant_at_point(obj, x, y)
        ...
        result = AXUtilitiesComponent._get_descendant_at_point(child, x, y)
