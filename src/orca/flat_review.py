...
class Zone:
    ...
    def __init__(self, accessible, string, x, y, width, height, role=None):
        ...
        self.width = width
        self.height = height
        self.role = role or Atspi.Accessible.get_role(accessible)
        self._words = []
    ...
    def onSameLine(self, zone):
        ...
        try:
            thisParentRole = Atspi.Accessible.get_role(self.accessible.parent)
            zoneParentRole = Atspi.Accessible.get_role(zone.accessible.parent)
        except:
            pass
        else:
        ...
        if True or not self.brailleRegions:
            ...
            for zone in self.zones:
                ...
                if isinstance(zone, TextZone) and \
                   ((Atspi.Accessible.get_role(zone.accessible) in \
                         (Atspi.Role.TEXT,  
...
class Context:
    ...
    def __init__(self, script):
        ...
        isContainer = lambda x: x and Atspi.Accessible.get_role(x) in containerRoles
    ...
    def _insertStateZone(self, zones, accessible, extents):
        ...
        role = Atspi.Accessible.get_role(accessible)
