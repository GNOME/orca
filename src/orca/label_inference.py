...
class LabelInference:
    ...
    def _preferRight(self, obj):
        ...
        return Atspi.Accessible.get_role(obj) in onRightRoles
    ...
    def _preventRight(self, obj):
        ...
        return Atspi.Accessible.get_role(obj) in roles
    ...
    def _isSimpleObject(self, obj):
        ...
        children = [x for x in children if Atspi.Accessible.get_role(x) != Atspi.Role.LINK]
        if len(children) > 1:
            return False
    ...
    def _cannotLabel(self, obj):
        ...
        if Atspi.Accessible.get_role(obj) in nonLabelTextRoles:
            return True
    ...
    def _isWidget(self, obj):
        ...
        isWidget = Atspi.Accessible.get_role(obj) in widgetRoles
    ...
    def _getExtents(self, obj, startOffset=0, endOffset=-1):
        ...
        if text:
            ...
            if not Atspi.Accessible.get_role(obj) in skipTextExtents:
                if endOffset == -1:
                    try:
    ...
    def _isTable(self, obj):
        ...
        if Atspi.Accessible.get_role(obj) == Atspi.Role.TABLE:
            return True
    ...
    def inferFromTable(self, obj, proximityForRight=50):
        ...
        if [x for x in cells if x.childCount \
            and Atspi.Accessible.get_role(x[0]) != Atspi.Accessible.get_role(obj)]:
            return None, []
