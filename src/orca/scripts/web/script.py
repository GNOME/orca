...
class Script(default.Script):
    ...
    def sayAll(self, inputEvent, obj=None, offset=None):
        ...
        if not self.utilities.inDocumentContent():
            return super().sayAll(self, inputEvent, obj, offset)
    ...
    def _rewindSayAll(self, context, minCharCount=10):
        if not self.utilities.inDocumentContent():
            return super()._rewindSayAll(self, context, minCharCount)
    ...
    def _fastForwardSayAll(self, context):
        if not self.utilities.inDocumentContent():
            return super()._fastForwardSayAll(self, context)
    ...
    def __sayAllProgressCallback(self, context, progressType):
        if not self.utilities.inDocumentContent() or self._inFocusMode:
            super().__sayAllProgressCallback(self, context, progressType)
            return
    ...
    def panBrailleRight(self, inputEvent=None, panAmount=0):
        ...
        if self.flatReviewContext \
           ...
           or not self.isBrailleEndShowing():
            super().panBrailleRight(self, inputEvent, panAmount)
            return
