...
class Script(default.Script):
    ...
    def onCaretMoved(self, event):
        ...
        if lastKey == 'Down' \
           ...
           and Atspi.Accessible.get_role(orca_state.locusOfFocus) == Atspi.Role.LINK:
    ...
    def sayLine(self, obj):
        ...
        for (obj, start, end, string) in objects:
            ...
            if Atspi.Accessible.get_role(obj) in rolesToSpeak:
    ...
    def sayPhrase(self, obj, startOffset, endOffset):
        ...
        if len(phrase) and phrase != "\n":
            ...
            links = [x for x in obj if Atspi.Accessible.get_role(x) == Atspi.Role.LINK]
            if links:
