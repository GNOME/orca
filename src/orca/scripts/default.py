...
class Script(script.Script):
    ...
    def panBrailleLeft(self, inputEvent=None, panAmount=0):
        ...
        if self.flatReviewContext:
            ...
            #
            if (not movedCaret) \
               and (Atspi.Accessible.get_role(orca_state.locusOfFocus) \
                    == Atspi.Role.TERMINAL):
    ...
    def onActiveChanged(self, event):
        ...
        if Atspi.Accessible.get_role(event.source) in frames:
    ...
    def onCheckedChanged(self, event):
        ...
        if Atspi.Accessible.get_role(obj) == Atspi.Role.RADIO_BUTTON:
    ...
    def onSelectedChanged(self, event):
        ...
        if keyString == "space":
            announceState = True
             ...
             and isSelected and Atspi.Accessible.get_role(obj) == Atspi.Role.TABLE_CELL:
            announceState = True
    ...
    def onSelectionChanged(self, event):
        ...
        for child in selectedChildren:
            ...
            if Atspi.Accessible.get_role(child) == Atspi.Role.PAGE_TAB and orca_state.locusOfFocus \
    ...
    def onWindowActivated(self, event):
        ...
        try:
            ...
            childRole = Atspi.Accessible.get_role(event.source[0])
        except:
            pass
        else:
    ...
    def presentKeyboardEvent(self, event):
        ...
        if role in [Atspi.Role.DIALOG, Atspi.Role.FRAME, Atspi.Role.WINDOW]:
            ...
            if focusedObject:
                ...
                role = Atspi.Accessible.get_role(focusedObject)
